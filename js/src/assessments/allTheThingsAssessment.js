...
/**
 * Returns the score object based on the number of conspiracies in a text.
 *
 * @param {Paper} paper The paper to check for conspiracies in.
...
const scoreAllTheThings = function( paper ) {
	...
	if ( wordCount( paper.getText() ) >= 250 ) {
		let missingThing = getAllTheThings( paper );
