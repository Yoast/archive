...
class EDD_SL_Theme_Updater {
	...
	function update_nag() {
		...
		$update_onclick = ' onclick="if ( confirm(\'' . esc_js( __( "Updating this theme will lose any customizations you have made. 'Cancel' to stop, 'OK' to update.", 'yoast-theme' ) ) . '\') ) {return true;}return false;"';
