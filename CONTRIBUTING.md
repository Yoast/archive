...
__Please Note:__ GitHub is for bug reports and code contributions only - if you have a support question or a request for a customisation don't post here, go to our [Support Forum](http://wordpress.org/support/plugin/glue-for-yoast-seo-amp) instead.
...
* Push the changes to your fork and submit a pull request to the 'trunk' branch of the plugin repository.
